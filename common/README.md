# Binance Web3 Common Types and Utilities for Binance Connectors

[![Code Style: Black](https://img.shields.io/badge/code_style-black-black)](https://black.readthedocs.io/en/stable/)
[![PyPI version](https://img.shields.io/pypi/v/binance-web3-common)](https://pypi.python.org/pypi/binance-web3-common)
[![PyPI Downloads](https://img.shields.io/pypi/dm/binance-web3-common.svg)](https://pypi.org/project/binance-web3-common/)
[![Python version](https://img.shields.io/pypi/pyversions/binance-web3-common)](https://www.python.org/downloads/)
...
```bash
pip install binance-web3-common
```
