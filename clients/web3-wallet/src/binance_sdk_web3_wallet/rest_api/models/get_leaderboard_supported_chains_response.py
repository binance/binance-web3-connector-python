...
from binance_sdk_web3_wallet.rest_api.models.get_portfolio_supported_chains_response_data_inner import (
...
class GetLeaderboardSupportedChainsResponse(BaseModel):
    """
    ...
    data: Optional[List[GetPortfolioSupportedChainsResponseDataInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLeaderboardSupportedChainsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLeaderboardSupportedChainsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [
                        GetPortfolioSupportedChainsResponseDataInner.from_dict(_item)
