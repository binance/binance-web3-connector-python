...
class GetErc20ApproveTransactionResponseDataInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetErc20ApproveTransactionResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetErc20ApproveTransactionResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "data": obj.get("data"),
                "dexContractAddress": obj.get("dexContractAddress"),
