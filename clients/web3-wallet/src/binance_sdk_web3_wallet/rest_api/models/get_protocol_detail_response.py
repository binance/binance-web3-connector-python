...
from binance_sdk_web3_wallet.rest_api.models.get_protocol_detail_response_data import (
...
class GetProtocolDetailResponse(BaseModel):
    """
    ...
    data: Optional[GetProtocolDetailResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetProtocolDetailResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetProtocolDetailResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetProtocolDetailResponseData.from_dict(obj["data"])
