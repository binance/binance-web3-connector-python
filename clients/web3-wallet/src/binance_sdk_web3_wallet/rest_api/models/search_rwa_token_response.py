...
from binance_sdk_web3_wallet.rest_api.models.search_rwa_token_response_data_inner import (
...
class SearchRwaTokenResponse(BaseModel):
    """
    ...
    data: Optional[List[SearchRwaTokenResponseDataInner]] = Field(
        default=None, description="List of matched tickers and their tokenized assets."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchRwaTokenResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchRwaTokenResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [
                        SearchRwaTokenResponseDataInner.from_dict(_item)
