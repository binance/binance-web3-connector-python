...
from binance_sdk_web3_wallet.rest_api.models.verify_b402_payment_v1_request_body_payment_requirements_extra import (
...
class VerifyB402PaymentV1RequestBodyPaymentRequirements(BaseModel):
    """
    ...
    extra: Optional[VerifyB402PaymentV1RequestBodyPaymentRequirementsExtra] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyB402PaymentV1RequestBodyPaymentRequirements from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyB402PaymentV1RequestBodyPaymentRequirements from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "extra": (
                    VerifyB402PaymentV1RequestBodyPaymentRequirementsExtra.from_dict(
                        obj["extra"]
                    )
