...
class VerifyB402PaymentV1RequestBodyPaymentPayload(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyB402PaymentV1RequestBodyPaymentPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyB402PaymentV1RequestBodyPaymentPayload from a dict"""
        if obj is None:
            return None
