...
from binance_sdk_web3_wallet.rest_api.models.b402_payment_kind_v1_extra import (
...
class B402SettleRequestV1AllOfPaymentRequirements(BaseModel):
    """
    ...
    extra: Optional[B402PaymentKindV1Extra] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of B402SettleRequestV1AllOfPaymentRequirements from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of B402SettleRequestV1AllOfPaymentRequirements from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "extra": (
                    B402PaymentKindV1Extra.from_dict(obj["extra"])
