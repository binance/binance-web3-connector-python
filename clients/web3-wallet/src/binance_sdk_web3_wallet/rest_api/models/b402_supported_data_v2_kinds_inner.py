...
from binance_sdk_web3_wallet.rest_api.models.b402_supported_data_v2_kinds_inner_extra import (
...
class B402SupportedDataV2KindsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of B402SupportedDataV2KindsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of B402SupportedDataV2KindsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "extra": (
                    B402SupportedDataV2KindsInnerExtra.from_dict(obj["extra"])
