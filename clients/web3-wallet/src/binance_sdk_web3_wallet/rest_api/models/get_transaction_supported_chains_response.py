...
from binance_sdk_web3_wallet.rest_api.models.get_transaction_supported_chains_response_data_inner import (
...
class GetTransactionSupportedChainsResponse(BaseModel):
    """
    ...
    data: Optional[List[GetTransactionSupportedChainsResponseDataInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTransactionSupportedChainsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTransactionSupportedChainsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [
                        GetTransactionSupportedChainsResponseDataInner.from_dict(_item)
