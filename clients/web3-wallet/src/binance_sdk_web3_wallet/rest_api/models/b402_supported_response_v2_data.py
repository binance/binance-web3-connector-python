...
from binance_sdk_web3_wallet.rest_api.models.b402_supported_data_v2_kinds_inner import (
...
class B402SupportedResponseV2Data(BaseModel):
    """
    B402SupportedResponseV2Data
    """  # noqa: E501

    kinds: List[B402SupportedDataV2KindsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of B402SupportedResponseV2Data from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of B402SupportedResponseV2Data from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "kinds": (
                    [
                        B402SupportedDataV2KindsInner.from_dict(_item)
