...
from binance_sdk_web3_wallet.rest_api.models.get_address_recent_pn_l_response_data import (
...
class GetAddressRecentPnLResponse(BaseModel):
    """
    ...
    data: Optional[GetAddressRecentPnLResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAddressRecentPnLResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAddressRecentPnLResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetAddressRecentPnLResponseData.from_dict(obj["data"])
