...
from binance_sdk_web3_wallet.rest_api.models.get_aggregated_quote_response_data_inner import (
...
class GetAggregatedQuoteResponse(BaseModel):
    """
    ...
    data: Optional[List[GetAggregatedQuoteResponseDataInner]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAggregatedQuoteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAggregatedQuoteResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [
                        GetAggregatedQuoteResponseDataInner.from_dict(_item)
