...
from binance_sdk_web3_wallet.rest_api.models.list_de_fi_investments_response_data import (
...
class ListDeFiInvestmentsResponse(BaseModel):
    """
    ...
    data: Optional[ListDeFiInvestmentsResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListDeFiInvestmentsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListDeFiInvestmentsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    ListDeFiInvestmentsResponseData.from_dict(obj["data"])
