...
from binance_sdk_web3_wallet.rest_api.models.get_rwa_underlying_info_response_data import (
...
class GetRwaUnderlyingInfoResponse(BaseModel):
    """
    ...
    data: Optional[GetRwaUnderlyingInfoResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRwaUnderlyingInfoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRwaUnderlyingInfoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetRwaUnderlyingInfoResponseData.from_dict(obj["data"])
