...
from binance_sdk_web3_wallet.rest_api.models.get_token_dev_info_response_data import (
...
class GetTokenDevInfoResponse(BaseModel):
    """
    ...
    data: Optional[GetTokenDevInfoResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTokenDevInfoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTokenDevInfoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetTokenDevInfoResponseData.from_dict(obj["data"])
