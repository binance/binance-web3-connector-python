...
from binance_sdk_web3_wallet.rest_api.models.get_rwa_underlying_market_data_response_data import (
...
class GetRwaUnderlyingMarketDataResponse(BaseModel):
    """
    ...
    data: Optional[GetRwaUnderlyingMarketDataResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRwaUnderlyingMarketDataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRwaUnderlyingMarketDataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetRwaUnderlyingMarketDataResponseData.from_dict(obj["data"])
