...
from binance_sdk_web3_wallet.rest_api.models.get_rwa_token_issuance_platforms_response_data_inner import (
...
class GetRwaTokenIssuancePlatformsResponse(BaseModel):
    """
    ...
    data: Optional[List[GetRwaTokenIssuancePlatformsResponseDataInner]] = Field(
        default=None, description="List of RWA token issuance platforms."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRwaTokenIssuancePlatformsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRwaTokenIssuancePlatformsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [
                        GetRwaTokenIssuancePlatformsResponseDataInner.from_dict(_item)
