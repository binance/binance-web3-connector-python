...
from binance_sdk_web3_wallet.rest_api.models.b402_payment_kind_v2_extra import (
...
class B402PaymentKindV2(BaseModel):
    """
    B402PaymentKindV2
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of B402PaymentKindV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of B402PaymentKindV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "extra": (
                    B402PaymentKindV2Extra.from_dict(obj["extra"])
