...
class DefiPreviewFeeAndContractInteractWith(BaseModel):
    """
    The contract the action interacts with.
    """  # noqa: E501

    address: Optional[StrictStr] = Field(
        default=None, description="Target contract address."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefiPreviewFeeAndContractInteractWith from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefiPreviewFeeAndContractInteractWith from a dict"""
        if obj is None:
            return None
