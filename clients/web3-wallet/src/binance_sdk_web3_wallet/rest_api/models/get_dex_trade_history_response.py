...
from binance_sdk_web3_wallet.rest_api.models.get_dex_trade_history_response_data import (
...
class GetDexTradeHistoryResponse(BaseModel):
    """
    ...
    data: Optional[GetDexTradeHistoryResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDexTradeHistoryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDexTradeHistoryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetDexTradeHistoryResponseData.from_dict(obj["data"])
