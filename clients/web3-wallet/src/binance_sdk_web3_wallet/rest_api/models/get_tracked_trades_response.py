...
from binance_sdk_web3_wallet.rest_api.models.get_tracked_trades_response_data import (
...
class GetTrackedTradesResponse(BaseModel):
    """
    ...
    data: Optional[GetTrackedTradesResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTrackedTradesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTrackedTradesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetTrackedTradesResponseData.from_dict(obj["data"])
