...
from binance_sdk_web3_wallet.rest_api.models.get_de_fi_positions_response_data import (
...
class GetDeFiPositionsResponse(BaseModel):
    """
    ...
    data: Optional[GetDeFiPositionsResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeFiPositionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeFiPositionsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "msg": obj.get("msg"),
                "data": (
                    GetDeFiPositionsResponseData.from_dict(obj["data"])
