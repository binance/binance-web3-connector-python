...
class DefiPreviewHealthFactor(BaseModel):
    """
    ...
    before: Optional[StrictStr] = Field(
        default=None,
        description="Health factor before this transaction. Null when unavailable.",
    )
    after: Optional[StrictStr] = Field(
        default=None,
        description="Health factor after this transaction. Null when unavailable.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefiPreviewHealthFactor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefiPreviewHealthFactor from a dict"""
        if obj is None:
            return None
